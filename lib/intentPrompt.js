...
export const VALID_INTENTS = [
  'save', 'correct', 'converse', 'search_request', 'reminder', 'recall', 'web_search', 'preferences',
];
...
Return ONLY valid JSON (no markdown):
{
  "tasks": [
    {
      "intent": "save" | "reminder" | "recall" | "correct" | "search_request" | "web_search" | "preferences" | "converse",
      "title": string,
