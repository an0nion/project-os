...
export const PROJECTS = [
...

  {
    ...
    keywords:    ['appointment', 'dentist', 'doctor', 'remind me', 'reminder',
                  'personal errand', 'personal task'],
    description: 'Personal reminders, appointments, life admin, errands',
    system_prompt: 'You are a personal life assistant. Help organise appointments, errands, and personal tasks. Be practical and concise.',
  },

  {
    ...
    keywords:    ['assignment', 'homework', 'exam', 'lecture', 'coursework',
                  'semester', 'subject', 'study for', 'uni', 'university',
                  'college', 'school deadline', 'lab report', 'tute', 'tutorial class'],
...
For general study help: explain concepts clearly, suggest study approaches, help draft essays or lab reports. Be structured and precise.`,
...

  {
    ...
    keywords:    ['fellowship', 'apply', 'residency', 'internship',
                  'job application', 'research application', 'want to apply'],
...

  {
    ...
    keywords:    ['workout', 'gym', 'lifting', 'cardio', 'stretch', 'training plan',
                  'weight training', 'push day', 'pull day', 'leg day', 'running plan'],
...

  {
    ...
    keywords:    ['want to learn', 'github.com', 'repo', 'repository',
                  'machine learning', 'deep learning', 'neural', 'transformer', 'dataset',
                  'arxiv', 'algorithm', 'pytorch', 'tensorflow', 'llm', 'research paper',
                  'diffusion', 'fine-tune', 'embedding', 'hugging face', 'huggingface',
                  'colab', 'notebook', '[personal learning]', 'papers with code'],
...

  {
    ...
    keywords:    ['book', 'novel', 'philosophy', 'author', 'chapter', 'passage', 'quote',
                  'want to read', 'reading list', 'fiction', 'nonfiction'],
